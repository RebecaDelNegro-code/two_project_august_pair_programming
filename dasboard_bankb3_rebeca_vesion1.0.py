'''
Objetivo: Aplicação completa em abas, com identidade visual inspirada na B3 (azul escuro e amarelo/dourado)
 incluindo controle de caixa, simulação de compra de Criptoativos e Extrato.

Conceitos: Componentes avançados (ttk.Notebook), gerenciamento de estado da aplicação,
 simulação de ativos digitais.
